    ...
    <div>
      ...
      <div className='py-24 px-20 flex flex-col justify-start items-center gap-27'>
        <div className='self-stretch flex flex-col gap-13'>
          ...
          <div className='px-10'>
            <div className='flex justify-between items-center py-9 px-12 rounded-[5px] border border-solid border-[#000] bg-white text-[#000] gap-10 overflow-hidden'>
              <input
                type='text'
                minLength={8}
                maxLength={16}
              ...
              />
              <EyeOpen className='hover:cursor-pointer shrink-0' />
            </div>
          </div>
        </div>
